...
#define ONVIF_HTTP_PORT                         8858/*  */
#define ONVIF_HTTPS_PORT                        8443/*  */
#define ONVIF_RTSP_PORT                         8554/*  */
#define	ONVIF_REQ_LISTEN_PORT	                  8858
#define ADAPTERNUM_MAX                          5 /*  */
#define MCAST_DATA 				                "Sean: BROADCAST TEST DATA"    /*?ಥ???͵?????*/
#define	ETHERNET_ADAPT                          "eth0"      //eth0  ens33
...
#if ONVIF_DEBUG
#define PRINT_DBG(fmt, args...)            printf("duke: %s:%d():"fmt"\n", __FILE__, __LINE__,##args);/*  */
#else
