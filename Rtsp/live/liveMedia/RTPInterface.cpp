...
//  makeSocketNonBlocking(fGS->socketNum()); //edit by duke 2020.12.10
  //increaseSendBufferTo(envir(), fGS->socketNum(), 50*1024);
   increaseSendBufferTo(envir(), fGS->socketNum(), 512*1024); //edit by duke 2019.12.26
}
